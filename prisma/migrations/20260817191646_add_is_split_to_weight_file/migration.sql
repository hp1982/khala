...
INSERT INTO "new_weight_file" ("adminId", "createdAt", "downloadAddress", "fileHash", "hashType", "id", "name", "qbit", "size", "updatedAt") SELECT "adminId", "createdAt", "downloadAddress", "fileHash", "hashType", "id", "name", "qbit", "size", "updatedAt" FROM "weight_file";
